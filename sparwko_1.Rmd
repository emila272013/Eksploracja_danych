...
#opts_chunk$set(dev = "svglite") # żeby były polskie znaki na wykresach
...
kable(t(tab_), caption = "Liczności dla danych jakościowych", booktabs = TRUE) %>%
  kable_styling(full_width = FALSE, 
                latex_options = c("striped", "scale_down", "hold_position"))
...
kable(tab_pay, caption = "Liczności dla metod płatności (PaymentMethod)", booktabs = TRUE, row.names = FALSE) %>%
  kable_styling(full_width = FALSE, 
